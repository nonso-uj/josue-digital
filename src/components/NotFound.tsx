  ...
  return (
    ...
    <div className="container">
        <div className="error-page-content text-center">
            <div className="logo w-75 mb-75 rmb-35 mx-auto " data-aos="fade-up" data-aos-delay="200">
                <Link to={"/"}>
            ...
            <div className="row justify-content-center " data-aos="fade-up" data-aos-delay="200">
                <div className="col-xl-8 col-lg-10">
                    ...
                    <p>Don't worry, even the best explorers occasionally get lost. Let's guide you back to where you intended to be. Click here to return to the main page and continue your journey with us. Thank you for your understanding!</p>
                </div>
            </div>
            <div className="btn-social pt-15 " data-aos="fade-up" data-aos-delay="400">
                <Link to={"/"} className="theme-btn mb-30 mx-2">Go to Home <i className="fas fa-long-arrow-right"></i></Link>
